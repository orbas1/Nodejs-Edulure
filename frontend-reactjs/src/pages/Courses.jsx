...
import CourseCatalogueCard from '../components/course/CourseCatalogueCard.jsx';
...
function mapCatalogueCourse(course) {
  ...
  return {
    ...
    previewVideoUrl: course.promoVideoUrl ?? course.previewVideoUrl ?? null,
    previewAspectRatio: course.previewAspectRatio ?? course.heroAspectRatio ?? '3:2',
    previewCaption: course.previewCaption ?? course.promoVideoTitle ?? null,
    previewMetadata: {
      source: course.previewSource ?? course.catalogueSource ?? undefined,
      freshnessLabel: course.previewUpdatedAt ?? course.updatedAt ?? undefined,
      caption: course.previewCaption ?? undefined
    },
    scheduleLabel: course.scheduleLabel ?? course.cadenceLabel ?? null,
    durationLabel: course.durationLabel ?? course.duration ?? null,
    certificateLabel: course.certificateLabel ?? course.certificateType ?? null,
        ...
        <section className="space-y-6">
          ...
          <div className="grid gap-6 lg:grid-cols-2">
            {highlightCourses.map((course) => (
              <CourseCatalogueCard key={course.id} course={course} onPurchase={openCheckout} />
            ))}
        ...
        <section className="space-y-6">
          ...
          <div className="grid gap-6 lg:grid-cols-2">
            {catalogueCourses.map((course) => {
              ...
              return <CourseCatalogueCard key={mapped.id} course={mapped} onPurchase={openCheckout} />;
            })}
