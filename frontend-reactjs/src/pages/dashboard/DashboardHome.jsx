      ...
      <section className="grid gap-6 lg:grid-cols-5">
        <div className="dashboard-panel lg:col-span-3">
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="text-sm font-semibold uppercase tracking-wide text-slate-500">Learner Profile</p>
              <h2 className="text-2xl font-semibold text-slate-900">{profile?.name ?? 'Learner'}</h2>
              <p className="text-sm text-slate-500">{profile?.title ?? 'Active learner'}</p>
            </div>
          </div>
      ...
      <section className="grid gap-6 lg:grid-cols-5">
        <div className="dashboard-panel lg:col-span-3">
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="text-xs uppercase tracking-wide text-slate-500">Instructor-in-residence</p>
              <h2 className="text-2xl font-semibold text-slate-900">{profile?.name ?? 'Instructor'}</h2>
              <p className="text-sm text-slate-500">Cohort architect & facilitator</p>
            </div>
          </div>
        ...
        <div className="dashboard-panel lg:col-span-2">
          ...
          <ul className="mt-4 space-y-3">
            {revenueSlices.map((slice) => (
              <li key={slice.name} className="flex items-center justify-between dashboard-card-muted px-4 py-3 text-sm">
