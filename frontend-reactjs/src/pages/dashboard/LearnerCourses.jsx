        ...
        <div className="mt-5 space-y-4">
          {active.map((course) => (
            <button
              ...
              className="w-full rounded-2xl border border-slate-200 bg-slate-100 p-5 text-left transition hover:border-primary hover:bg-slate-100"
            >
      ...
      <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
        ...
        <div className="mt-5 grid gap-4 md:grid-cols-2">
          {recommendations.map((rec) => (
            <div key={rec.id} className="rounded-2xl border border-slate-200 bg-slate-100 p-5">
