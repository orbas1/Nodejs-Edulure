    ...
    <div className="space-y-8">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        <div>
          ...
          <p className="mt-2 text-sm text-slate-500">Track performance of your published guides across the Edulure network.</p>
        </div>
        <button
          type="button"
      ...
      <section className="grid gap-4 md:grid-cols-3">
        {catalogue.map((ebook) => (
          <div key={ebook.id} className="dashboard-panel">
            ...
            <p className="mt-2 text-sm text-slate-500">{ebook.downloads} downloads</p>
