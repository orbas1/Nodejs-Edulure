    ...
    <div className="space-y-10">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        <div>
          ...
          <p className="dashboard-subtitle">Structure your next cohort with guided scaffolding and production support.</p>
        </div>
      ...
      <section className="grid gap-6 md:grid-cols-2">
        {[
          ...
          <div key={card.title} className="dashboard-section">
