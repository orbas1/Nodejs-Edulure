...
export class SecurityOperationsService {
     ...
     * @throws ApiError
     */
    static listSecurityRisks(tenantId, limit, offset, status, category, ownerId, tag, severity, includeClosed, sortBy, sortDirection, search) {
     ...
     * @throws ApiError
     */
    static updateSecurityRiskStatus(riskId, requestBody) {
        return __request(OpenAPI, {
            method: 'PATCH',
     ...
     * @throws ApiError
     */
    static recordSecurityRiskReview(riskId, requestBody) {
        return __request(OpenAPI, {
            method: 'POST',
     ...
     * @throws ApiError
     */
    static listSecurityAuditEvidence(tenantId, framework, controlReference, riskId, status, limit, offset) {
        return __request(OpenAPI, {
            method: 'GET',
     ...
     * @throws ApiError
     */
    static listSecurityContinuityExercises(tenantId, outcome, ownerId, since, limit, offset) {
        return __request(OpenAPI, {
            method: 'GET',
     ...
     * @throws ApiError
     */
    static listSecurityAssessments(tenantId, status, assessmentType, scheduledFrom, scheduledTo, limit, offset) {
        return __request(OpenAPI, {
            method: 'GET',
...
//# sourceMappingURL=SecurityOperationsService.js.map