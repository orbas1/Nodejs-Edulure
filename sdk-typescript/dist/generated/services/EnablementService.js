...
export class EnablementService {
     ...
     * @throws ApiError
     */
    static getEnablementArticles(audience, product, tag, q, limit = 25, offset) {
     ...
     * @throws ApiError
     */
    static getEnablementArticles1(slug, format = 'markdown') {
        return __request(OpenAPI, {
            method: 'GET',
     ...
     * @throws ApiError
     */
    static getEnablementCapabilityMatrix() {
        return __request(OpenAPI, {
            method: 'GET',
...
//# sourceMappingURL=EnablementService.js.map