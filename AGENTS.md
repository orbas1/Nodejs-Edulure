...
2. Part 2 — User Experience Audit & Component Breakdown
      ...
      - ✓ 6.B Instructor Deep-dive Modules
        ...
        10. **Data Integration.** Launch checklists, risk logs, recommendation histories, and pricing streams expect richer backend payloads seeded in Annex B2 migrations—when absent, defaults still render explanatory copy so pre-release tenants retain a coherent narrative.
      ...
      - ✓ 6.C Creation Studio & Course Tooling
        ...
        9. **Data Contracts.** Updated PropTypes document the new optional fields (`passingScore`, `proctoring`, `launchWindow`, `syndication.channels`, `module.risks`, `CourseProgressBar.target`), guiding API providers toward the richer payloads that Annex case studies rely on.
