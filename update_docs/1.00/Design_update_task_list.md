...
- **Subtasks:**
  ...
  3. Compile security/privacy overlays for settings, payments, verification, and consent prompts.
  4. Produce engineering handoff kits with specs, interaction recordings, analytics matrices, and asset manifests.
