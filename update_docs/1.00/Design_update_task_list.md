...
- **Subtasks:**
  ...
  4. Specify card, form, and modal components including error/empty states and data placeholders (`Cards.md`, `Forms.md`). _Update:_ Checkout forms, coupon inputs, refund modals, receipt banners, and finance alerts mirror the new payment flows, documenting SCA handoff messaging, webhook retry states, ledger export buttons, and the expanded provider/learner wireframes captured in `provider_app_wireframe_changes.md` and `user_app_wireframe_changes.md` using `web_application_styling_changes.md`, `user_application_styling_changes.md`, and `component_functions.md`.
