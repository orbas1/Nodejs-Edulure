...
- **Exit Criteria:**
  ...
  - Operator dashboard mockups reference live service readiness telemetry delivered by the backend squad to ensure health banners and incident shortcuts reflect real-time status.【F:backend-nodejs/src/servers/webServer.js†L19-L94】
