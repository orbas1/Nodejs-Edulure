...
describe('BusinessIntelligenceService', () => {
  ...
  it('builds an executive overview with deltas, experiments, and data quality', async () => {
    ...
    expect(overview.scorecard.netRevenue.currency).toBe('USD');
    expect(overview.scorecard.recognisedRevenue.currency).toBe('USD');
  ...
  it('returns revenue saved views with computed deltas and ratios', async () => {
    ...
    expect(netMetric.currency).toBe('USD');
    expect(netView.filters.currency).toBe('USD');
    expect(netView.chart[0].currency).toBe('USD');
    ...
    expect(healthView.filters.currency).toBe('USD');
    ...
    expect(leakageView.filters.currency).toBe('USD');
