...
process.env.COMMUNITY_REMINDER_IDEMPOTENCY_MINUTES =
  process.env.COMMUNITY_REMINDER_IDEMPOTENCY_MINUTES ?? String(24 * 60);
process.env.COMMUNITY_REMINDER_STATE_RETENTION =
  process.env.COMMUNITY_REMINDER_STATE_RETENTION ?? '1000';
process.env.COMMUNITY_REMINDER_DISPATCH_INTERVAL_MS =
  process.env.COMMUNITY_REMINDER_DISPATCH_INTERVAL_MS ?? '0';
...
process.env.TELEMETRY_INGESTION_ENABLED = process.env.TELEMETRY_INGESTION_ENABLED ?? 'true';
process.env.TELEMETRY_ALLOWED_SOURCES =
  process.env.TELEMETRY_ALLOWED_SOURCES ?? 'web,backend,worker';
process.env.TELEMETRY_STRICT_SOURCE_ENFORCEMENT =
  process.env.TELEMETRY_STRICT_SOURCE_ENFORCEMENT ?? 'false';
process.env.TELEMETRY_DEFAULT_SCOPE =
  process.env.TELEMETRY_DEFAULT_SCOPE ?? 'product.analytics';
process.env.TELEMETRY_CONSENT_DEFAULT_VERSION =
  process.env.TELEMETRY_CONSENT_DEFAULT_VERSION ?? 'v1';
process.env.TELEMETRY_CONSENT_HARD_BLOCK =
  process.env.TELEMETRY_CONSENT_HARD_BLOCK ?? 'true';
process.env.TELEMETRY_EXPORT_ENABLED = process.env.TELEMETRY_EXPORT_ENABLED ?? 'true';
process.env.TELEMETRY_EXPORT_DESTINATION =
  process.env.TELEMETRY_EXPORT_DESTINATION ?? 's3';
process.env.TELEMETRY_EXPORT_BUCKET =
  process.env.TELEMETRY_EXPORT_BUCKET ?? 'edulure-telemetry';
process.env.TELEMETRY_EXPORT_PREFIX =
  process.env.TELEMETRY_EXPORT_PREFIX ?? 'warehouse/telemetry';
process.env.TELEMETRY_EXPORT_BATCH_SIZE =
  process.env.TELEMETRY_EXPORT_BATCH_SIZE ?? '5000';
process.env.TELEMETRY_EXPORT_COMPRESS =
  process.env.TELEMETRY_EXPORT_COMPRESS ?? 'true';
process.env.TELEMETRY_EXPORT_RUN_ON_STARTUP =
  process.env.TELEMETRY_EXPORT_RUN_ON_STARTUP ?? 'true';
process.env.TELEMETRY_EXPORT_CRON = process.env.TELEMETRY_EXPORT_CRON ?? '*/10 * * * *';
process.env.TELEMETRY_EXPORT_TIMEZONE =
  process.env.TELEMETRY_EXPORT_TIMEZONE ?? 'Etc/UTC';
process.env.TELEMETRY_FRESHNESS_INGESTION_THRESHOLD_MINUTES =
  process.env.TELEMETRY_FRESHNESS_INGESTION_THRESHOLD_MINUTES ?? '15';
process.env.TELEMETRY_FRESHNESS_WAREHOUSE_THRESHOLD_MINUTES =
  process.env.TELEMETRY_FRESHNESS_WAREHOUSE_THRESHOLD_MINUTES ?? '30';
