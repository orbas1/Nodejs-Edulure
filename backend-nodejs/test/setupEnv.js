...
process.env.STRIPE_WEBHOOK_SECRET = process.env.STRIPE_WEBHOOK_SECRET ?? 'whsec_test_secret_1234567890';
process.env.STRIPE_DEFAULT_STATEMENT_DESCRIPTOR =
  process.env.STRIPE_DEFAULT_STATEMENT_DESCRIPTOR ?? 'EDULURE TEST';
process.env.PAYPAL_CLIENT_ID = process.env.PAYPAL_CLIENT_ID ?? 'paypal-test-client-id-1234567890';
process.env.PAYPAL_CLIENT_SECRET = process.env.PAYPAL_CLIENT_SECRET ?? 'paypal-test-secret-9876543210';
process.env.PAYPAL_ENVIRONMENT = process.env.PAYPAL_ENVIRONMENT ?? 'sandbox';
process.env.PAYPAL_WEBHOOK_ID = process.env.PAYPAL_WEBHOOK_ID ?? 'WH-TEST-123456';
process.env.PAYMENT_ORDER_EXPIRY_MINUTES = process.env.PAYMENT_ORDER_EXPIRY_MINUTES ?? '90';
process.env.PAYMENT_ALLOWED_CURRENCIES = process.env.PAYMENT_ALLOWED_CURRENCIES ?? 'USD,EUR,GBP';
