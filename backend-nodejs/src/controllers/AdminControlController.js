...
const courseUpdateSchema = courseCreateSchema.fork(['title', 'instructorId'], (schema) => schema.optional());
...
const liveStreamUpdateSchema = liveStreamCreateSchema.fork(['title', 'startAt', 'endAt'], (schema) => schema.optional());
