...
export class IntegrationOrchestratorService {
  ...
  async recordRunOutcomeSafe(payload) {
    ...
    try {
      ...
      this.logger.warn(
        { err: error, integration: payload.integration, trigger: payload.triggeredBy },
        'Failed to record integration status outcome'
      );
    }
  }
  ...
  async getStatusSafe(integration, environment) {
    ...
    try {
      ...
      this.logger.warn(
        { err: error, integration, environment },
        'Failed to resolve integration status snapshot'
      );
      return null;
    }
  }
  ...
  async summariseCallsSafe(integration, options) {
    ...
    try {
      ...
      this.logger.warn(
        { err: error, integration, options },
        'Failed to summarise integration call activity'
      );
      return null;
    }
  }
